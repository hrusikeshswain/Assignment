...
//                RandomString gen = new RandomString(8, ThreadLocalRandom.current());
                ...
                db.addItems(RandomString.generateString(),"Chapati");
                db.addItems(RandomString.generateString(),"Dal");
                db.addItems(RandomString.generateString(),"Sabzi");
                db.addItems(RandomString.generateString(),"Raita");
                db.addItems(RandomString.generateString(),"Paratha");
                db.addItems(RandomString.generateString(),"Rice");
